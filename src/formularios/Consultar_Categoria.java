...
public class Consultar_Categoria extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
         String idCategoriaStr = txtId.getText(); // Obtener el ID ingresado
    if (!idCategoriaStr.isEmpty()) {
        try {
            int idCategoria = Integer.parseInt(idCategoriaStr); // Convertir el texto a entero
            crudCategoria operaciones = new crudCategoria(); // Instancia del CRUD
            DefaultTableModel modelo = operaciones.buscarCategoriaPorId(idCategoria); // Buscar por ID
            TdatosCategoria.setModel(modelo); // Actualizar la tabla con el modelo obtenido
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(null, "Por favor, ingrese un ID válido (número entero).");
        }
    } else {
        JOptionPane.showMessageDialog(null, "Por favor, ingrese un ID de categoría.");
    }
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
    crudCategoria operaciones = new crudCategoria(); // Instancia del CRUD
    DefaultTableModel modelo = operaciones.obtenerCategorias(); // Obtener todas las categorías
    TdatosCategoria.setModel(modelo); // Actualizar la tabla con el modelo obtenido
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Consultar_Categoria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
