...
public class Consultar_Producto extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
          String idProductoStr = txtId.getText();
        if (!idProductoStr.isEmpty()) {
            int idProducto = Integer.parseInt(idProductoStr);
            crudProductos operaciones = new crudProductos();
            DefaultTableModel modelo = operaciones.buscarProductoPorId(idProducto);
            TdatosProducto.setModel(modelo);
        } else {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        DefaultTableModel modelo = operaciones.llenarTodosLosProductos();
        TdatosProducto.setModel(modelo); // Llenar la tabla con todos los productos
